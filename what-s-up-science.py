...
if data is not None:    
    ...
    df.groupby(['Publisher']).sum().plot(kind='pie',radius = 0.6, subplots=True, legend= True, frame = True, ylabel='',labeldistance=None, fontsize=10, figsize=(10,10),colormap='Set3')
