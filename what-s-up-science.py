...
if data is not None:    
    ...
    plt.margins(0,0)
    row2col1.markdown("<h2 style='text-align: center; font-size:10px; color: White;'>Top 10 Publishers</h2>", unsafe_allow_html=True)
    row2col1.pyplot()
    ...
    plt.margins(0,0)
    row2col3.markdown("<h2 style='text-align: center; font-size:10px; color: White;'>Top 10 Domains</h2>", unsafe_allow_html=True)
    row2col3.pyplot()  
