...
if data is not None:    
    ...
    df.groupby(['Publisher']).sum().plot(kind='pie',facecolor='black' radius = 0.6, subplots=True, legend= True, ylabel='',labeldistance=None, fontsize=10, figsize=(10,10),colormap='Set3')
