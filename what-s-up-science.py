...
if data is not None:    
    ...
    df.groupby(['Publisher']).sum().plot(kind='pie', radius = 0.9, subplots=(True,fontsize=10), legend= True, ylabel='',labeldistance=None, fontsize=10, figsize=(9,9),colormap='Set3')
